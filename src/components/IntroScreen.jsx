...
const JOURNEY = [
  ...
  { num: '02', icon: '📖', label: 'Story',    desc: "Alex & Emma's fair tokens" },
...
export default function IntroScreen({ state, dispatch }) {
  ...
  return (
    <div className="intro-wrap anim-fade-in">
      {/* Top Badge */}
      <div className="intro-top-badge">
        ✨ Curriculum · Relation Between Addition &amp; Subtraction Grade 2
      </div>

      {/* Main Title */}
      <h1 className="intro-title">
        <span className="text-orange">Addition &amp; Subtraction</span> <span className="text-white">Quest</span>
      </h1>
      <h2 className="intro-subtitle">
        Master Fact Families, Part-Part-Whole &amp; Inverse Operations
      </h2>
      ...
      <div className="intro-mascot-row">
        ...
        <div className="intro-speech-bubble">
          Hi! I'm Pip the Math Owl! Ready to explore how addition unlocks subtraction with Alex and Emma? 🔺✨
        </div>
      </div>

      {/* Description */}
      <p className="intro-desc">
        Discover how numbers work together in Fact Families, balance math scales, operate the Inverse Machine, and conquer 10 magical math worlds!
      </p>
